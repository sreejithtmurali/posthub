...
class AdvDetailsOneScreen extends StatelessWidget {
  AdvDetailsOneScreen({Key? key}) : super(key: key);
  ...
  /// Section Widget
  CustomElevatedButton _buildExtend(BuildContext context) {
  ...
  onTapTxtEditMore(BuildContext context) {
    //Navigator.pushNamed(context, Router.editTabContainerScreen);
  }
}
